...
import {
  ...
  const graphWidth = CanvasWidth - 2;9
  
  export default function Graph () {
    const dairyImage = useImage(require('../screens/FoodIcons/Dairy.png'))
    const fruitVegImage = useImage(require('../screens/FoodIcons/FruitVeg.png'))
    const cupboardImage = useImage(require('../screens/FoodIcons/Cupboard.png'))
